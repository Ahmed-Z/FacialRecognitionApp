...
class Signin extends React.Component{
    ...
    onSubmitSignIn = () =>{
        fetch('https://facialreco.herokuapp.com/signin',
        {
            method: 'post',
        ...
        .then(data => {
            ...
            this.props.onRouteChange('home');
                ...
                this.setState({userExist: "incorrect login information"})
            }
        })   
            ...
            <main className="pa4 black-80">
                <div className="measure">
                    <fieldset id="sign_up" className="ba b--transparent ph0 mh0">
                        ...
                        <div className="w-100">
                            <p id="error" className="red animated shake">{this.state.userExist}</p>
                        </div>
